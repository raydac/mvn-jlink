...
public abstract class AbstractJdkProvider {
   ...
   */
  public static int unpackArchive(@Nonnull final Log logger, @Nonnull final File archiveFile, @Nonnull final File destinationFolder, @Nonnull @MustNotContainNull final String... folders) throws IOException {
